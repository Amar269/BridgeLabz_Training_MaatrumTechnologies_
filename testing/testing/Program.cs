...
namespace FileProcessingSystem
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            IFileFactory csvFactory = new CsvFactory();

            IFileWriter csvWriter = csvFactory.CreateWriter();

            csvWriter.WriteFile("student.csv", student);

            IFileReader csvReader = csvFactory.CreateReader();
            ...
            IFileWriter jsonWriter = jsonFactory.CreateWriter();

            jsonWriter.WriteFile("student.json", student);

            IFileReader jsonReader = jsonFactory.CreateReader();
